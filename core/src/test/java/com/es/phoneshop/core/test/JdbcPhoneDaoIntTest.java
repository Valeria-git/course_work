...
import com.es.phoneshop.core.model.phone.ColorBahtinova;
...
public class JdbcPhoneDaoIntTest {
    ...
    private PhoneBahtinova testPhone;
    private Set<ColorBahtinova> testColorSet;
    private ColorBahtinova brown;
    private ColorBahtinova yellow;

    @Before
    public void initializeTestData() {
        testPhone = new PhoneBahtinova();
        ...
        brown = new ColorBahtinova(1012L, "Brown");
        yellow = new ColorBahtinova(1002L, "Yellow");
    ...
    public void checkInstanceOfPhone_Get() {
        Assert.assertTrue(phoneDao.get(1100L).get() instanceof PhoneBahtinova);
    }
