...
public class PhoneBahtinova {
    ...
    private Set<ColorBahtinova> colors = Collections.EMPTY_SET;
    ...
    public Set<ColorBahtinova> getColors() {
        return colors;
    }

    public void setColors(Set<ColorBahtinova> colors) {
        this.colors = colors;
    }
    ...
    public boolean equals(Object object){
        ...
        PhoneBahtinova comparedPhone = (PhoneBahtinova) object;
