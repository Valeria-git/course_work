...
<%@ taglib prefix="sec" uri="http://www.springframework.org/security/tags" %>
 ...
 <p>
 <a href="${contextUrl}cart"> Моя корзина. </a> Количество: <b id="resultItems">${httpSessionCartService.getItemsNum()}</b> Общая стоимость: $ <b id="resultPrice">${httpSessionCartService.getOverallPrice()}</b>
 <br>
 <br>
 <c:choose>
