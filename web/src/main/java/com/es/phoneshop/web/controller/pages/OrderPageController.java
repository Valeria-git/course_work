...
import com.es.phoneshop.core.order.OrderServiceBahtinova;
...
public class OrderPageController {
    ...
    @Resource
    private OrderServiceBahtinova orderService;
    ...
    public String placeOrder(@ModelAttribute("clientInformationForm") @Valid ClientInformationForm form, BindingResult result, Model model,
        ...
        if(result.hasErrors()) {
            ...
            OrderBahtinova order = orderService.createOrder();
    ...
    private void setClientInfo(OrderBahtinova order, ClientInformationForm form) {
